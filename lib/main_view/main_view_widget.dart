                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        'Save your medicines and equiment stock',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText2
                                            .override(
                                              fontFamily: 'Lexend Deca',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'Search for medicines that people are donating',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText2
                                          .override(
                                            fontFamily: 'Lexend Deca',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'List of items that are there in your stock',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText2
                                          .override(
                                            fontFamily: 'Lexend Deca',
                      ...
                      child: Visibility(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => InkWell(
                            onTap: () async {
                              context.pushNamed('transfer_view');
                            },
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    ' items that are in transit/transferred for recycle /redistribution',
