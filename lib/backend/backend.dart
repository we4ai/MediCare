...
import 'schema/transfer_order_record.dart';
...
export 'schema/transfer_order_record.dart';
...
/// Functions to query TransferOrderRecords (as a Stream and as a Future).
Future<int> queryTransferOrderRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TransferOrderRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TransferOrderRecord>> queryTransferOrderRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<TransferOrderRecord>> queryTransferOrderRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<TransferOrderRecord>> queryTransferOrderRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
